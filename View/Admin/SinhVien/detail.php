...
<ul class="breadcrumbs">
    ...
    <li class="divider">/</li>
    <li><a href="#" class="active">Thông Tin Sinh Viên <?php echo $dataid['TenSinhVien'] ?></a> </li>
</ul>
		...
		<div class="col-12">
			<form method="POST">
				<div class="input-group">
					<input type="text" name="txtTenSinhVien" disabled value="<?php echo $dataid['TenSinhVien'] ?>" required/>
				...
				<!-- <div class="col-12">
					...
					<a class="btn btn-primary" href="index.php?controller=SinhVien&action=list">Trở về danh sách</a>
					<a class="btn btn-warning" href="index.php?controller=SinhVien&action=edit&id=<?php echo $dataid['MSSV']?>">Sửa Sinh Viên</a>
					<a class="btn btn-danger" href="index.php?controller=SinhVien&action=delete&id=<?php echo $dataid['MSSV']?>" onclick="return confirm('Bạn có chắc chắn muốn xóa sinh viên này chứ?')"  >Xóa Sinh Viên</a>
			</form>
		</div>
	</div>
</div>
